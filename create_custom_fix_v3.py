...
for row in processed_data:
    # row=[Table, Code, Desc, Unit, V1, V2, V3]
    ws_engine.cell(row=row_offset, column=2).value = row[0] # B
    ws_engine.cell(row=row_offset, column=3).value = row[0] # C
    ws_engine.cell(row=row_offset, column=4).value = row[1] # D
    ws_engine.cell(row=row_offset, column=5).value = row[2] # E
    ws_engine.cell(row=row_offset, column=6).value = row[3] # F
